...
function GuessCard({ onGameFinish, onQuitGame, selectedContinent }) {
    ...
    const handleQuitClick = () => {
        onQuitGame(correctGuesses, attemptedScore, correctGuesses, incorrectGuesses);
    };
    ...
    return (
        <div className="cardd">
            ...
            <div className="buttons-container">
                ...
                <button className="Quitbtn" onClick={handleQuitClick}>
                    Quit Game
                </button>{' '}
                {/* Add onClick handler */}
            </div>
